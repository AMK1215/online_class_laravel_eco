<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard-pro/pages/dashboards/analytics.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">UserManagement</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        <li class="nav-item mb-2 mt-0">
          <a data-bs-toggle="collapse" href="#ProfileNav" class="nav-link text-white" aria-controls="ProfileNav" role="button" aria-expanded="false">
            ...
            <span class="nav-link-text ms-2 ps-1"> {{ Auth::user()->user_name }} </span>
          </a>
          <div class="collapse" id="ProfileNav" style="">
            <ul class="nav ">
              <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('admin.profile.show') }}">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link text-white active" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
            ...
            <span class="nav-link-text ms-2 ps-1">PlayerDashboards</span>
          </a>
          <div class="collapse  show " id="dashboardsExamples">
            <ul class="nav ">
              <li class="nav-item active">
                <a class="nav-link text-white active" href="{{ route('admin.players.index') }}">
                  <span class="sidenav-mini-icon"> PL </span>
                  <span class="sidenav-normal  ms-2  ps-1"> PlayerList </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link text-white " href="{{ route('admin.vendors.index') }}">
                  <span class="sidenav-mini-icon"> V </span>
                  <span class="sidenav-normal  ms-2  ps-1"> Vendor </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link text-white " href="{{('admin.product-categories.index')}}">
                  <span class="sidenav-mini-icon"> PC </span>
                  <span class="sidenav-normal  ms-2  ps-1"> ProductCategory </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link text-white " href="{{ route('admin.product-statuses.index')}}">
                  <span class="sidenav-mini-icon"> PT </span>
                  <span class="sidenav-normal  ms-2  ps-1"> ProductStatus </span>
                </a>
              </li>
              <li class="nav-item ">
