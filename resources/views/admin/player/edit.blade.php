  ...
  <div class="row">
    <div class="col-12 col-md-8 mx-auto">
      <div class="card">
          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a class="btn btn-icon btn-2 btn-primary" href="{{ route('admin.players.index') }}">
        ...
        <div class="card-body">
          <form role="form" method="POST" class="text-start" action="{{ route('admin.players.update', $player->id) }}">
            @csrf
            @method('PUT')
