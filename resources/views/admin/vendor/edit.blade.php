      ...
      <div class="card-header pb-0">
        <div class="d-lg-flex">
          <div>
            ...
            <p class="text-sm mb-0">Edit the vendor details</p>
          </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group input-group-outline">
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $vendor->name }}">
                </div>
                @error('name')
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-outline">
                  <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror" 
                            required value="{{ $vendor->description }}">{{ $vendor->description }}</textarea>
                </div>
                @error('description')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-outline">
                  <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror" 
                          value="{{ $vendor->address }}">{{ $vendor->address }}</textarea>
                </div>
                @error('address')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="form-check form-switch ps-0">
                  <input class="form-check-input mt-1 ms-auto" type="checkbox" name="status" value="{{ $vendor->status }}" 
